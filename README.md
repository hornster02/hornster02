...
***7+ Taskbar Tweaker+WinaeroTweaker+ExplorerPatcher+Classic Color Panel*** (HKCU/Control Panel/Colors) - úprava uživatelského rozhraní Windows
...
***Registry Workshop*** - pokročilá náhrada výchozího "Regedit". Load Hive slouží pro načtení externího registru - je možné ho upravovat
...
***7+ Taskbar Tweaker+WinaeroTweaker+ExplorerPatcher+Classic Color Panel*** (HKCU/Control Panel/Colors) - modifying the Windows user interface
...
***Registry Workshop*** - advanced replacement of the default "Regedit". Load Hive used to load external registry - can be edited
